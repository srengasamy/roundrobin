...
public class BankAccountResourceTests extends ResourceTests {
  ...
  public void testCreate() {
    ...
    Response<BankAccountTo> created = helper
        .post(url + "bank-account", bankAccountTo, new ParameterizedTypeReference<Response<BankAccountTo>>() {}, port)
        .getBody();
  ...
  public void testCreateWithEmptyValue() {
    ...
    assertThat(created.getErrors(),
        hasItems(new Error(ErrorCode.INVALID_FIELD, "userProfileId: may not be empty"),
            new Error(ErrorCode.INVALID_FIELD, "bankName: may not be empty"),
  ...
  public void testCreateWithInvalidValue() {
    ...
    assertThat(created.getErrors(),
        hasItems(new Error(ErrorCode.INVALID_FIELD, "userProfileId: may not be empty"),
            new Error(ErrorCode.INVALID_FIELD, "bankName: length must be between 0 and 50"),
  ...
  public void testCreateWithInvalidProfileId() {
    ...
    Response<String> created =
        helper.post(url + "bank-account", bankAccountTo, new ParameterizedTypeReference<Response<String>>() {}, port)
            .getBody();
    assertThat(created.getErrors(), notNullValue());
    assertThat(created.getErrors(),
  ...
  public void testUpdate() {
    ...
    Response<BankAccountTo> updated = helper.put(url + "bank-account", created.getEntity(),
        new ParameterizedTypeReference<Response<BankAccountTo>>() {}, port).getBody();
    assertThat(updated.getEntity(), notNullValue());
    Response<BankAccountTo> read = helper.get(url + "bank-account/{bankAccountId}",
        new ParameterizedTypeReference<Response<BankAccountTo>>() {}, port, created.getEntity().getId()).getBody();
  ...
  public void testUpdateWithEmptyValues() {
    ...
    Response<String> updated =
        helper.put(url + "bank-account", bankAccountTo, new ParameterizedTypeReference<Response<String>>() {}, port)
            .getBody();
  ...
  public void testReadWithEmptyId() {
    Response<String> read = helper
        .get(url + "bank-account/{bankAccountId}", new ParameterizedTypeReference<Response<String>>() {}, port, " ")
        .getBody();
  ...
  public void testReadWithInvalidId() {
    Response<String> read = helper.get(url + "bank-account/{bankAccountId}",
  ...
  public void testDelete() {
    ...
    Response<BankAccountTo> created = helper
        ...
        .getBody();
    assertThat(created.getEntity(), notNullValue());
    Response<Boolean> deleted = helper.delete(url + "bank-account/{bankAccountId}",
    ...
    Response<Boolean> read = helper.get(url + "bank-account/{bankAccountId}",
        new ParameterizedTypeReference<Response<Boolean>>() {}, port, created.getEntity().getId()).getBody();
    assertThat(read.getEntity(), nullValue());
    assertThat(read.getErrors(), notNullValue());
    assertThat(read.getErrors(), hasItems(
  ...
  public void testDeleteWithEmptyId() {
    Response<String> deleted = helper
        .delete(url + "bank-account/{bankAccountId}", new ParameterizedTypeReference<Response<String>>() {}, port, " ")
        .getBody();
  ...
  public void testDeleteWithInvalidId() {
    Response<String> deleted = helper.delete(url + "bank-account/{bankAccountId}",
        new ParameterizedTypeReference<Response<String>>() {}, port, "testing").getBody();
    assertThat(deleted.getEntity(), nullValue());
    assertThat(deleted.getErrors(), notNullValue());
  ...
  public void testList() {
    ...
    Response<List<BankAccountTo>> list = helper
        .get(url + "bank-account?profileId={profileId}",
            new ParameterizedTypeReference<Response<List<BankAccountTo>>>() {}, port, null)// profile.getEntity().getId())
        .getBody();
  ...
  public void testListWithEmptyId() {
    Response<List<BankAccountTo>> list =
        helper.get(url + "bank-account", new ParameterizedTypeReference<Response<List<BankAccountTo>>>() {}, port, "")
            .getBody();
  ...
  public void testListWithEmptyProfileId() {
    Response<List<BankAccountTo>> list = helper.get(url + "bank-account?profileId={profileId}",
        new ParameterizedTypeReference<Response<List<BankAccountTo>>>() {}, port, "").getBody();
    assertThat(list.getEntity(), nullValue());
    assertThat(list.getErrors(), notNullValue());
    assertThat(list.getErrors(),
        hasItems(new Error(ErrorCode.INVALID_PROFILE_ID, messages.getErrorMessage(ErrorCode.INVALID_PROFILE_ID))));
  ...
  public void testListWithInvalidProfileId() {
    Response<List<BankAccountTo>> list = helper.get(url + "bank-account?profileId={profileId}",
        new ParameterizedTypeReference<Response<List<BankAccountTo>>>() {}, port, "testing").getBody();
    assertThat(list.getEntity(), nullValue());
    assertThat(list.getErrors(), notNullValue());
    assertThat(list.getErrors(),
        hasItems(new Error(ErrorCode.INVALID_PROFILE_ID, messages.getErrorMessage(ErrorCode.INVALID_PROFILE_ID))));
