...
public class SkillDetailResourceTests extends ResourceTests {
  ...
  public void testCreateWithNullValues() {
    SkillDetailTo skillDetailTo = new SkillDetailTo();
    Response<String> created = template.exchange(vaultUrl + "admin/skill-detail", HttpMethod.POST,
            createHttpEntity(skillDetailTo, createAdminHeader()),
  ...
  public void testUpdate() {
    ...
    Response<SkillDetailTo> updatedSkill = template.exchange(vaultUrl + "admin/skill-detail", HttpMethod.PUT,
    ...
    Response<SkillDetailTo> read =
            template.exchange(vaultUrl + "admin/skill-detail/{skillDetailId}", HttpMethod.GET,
  ...
  public void testUpdateWithEmptySkillId() {
    SkillDetailTo skillDetailTo = new SkillDetailTo();
    Response<SkillDetailTo> updatedSkill = template.exchange(vaultUrl + "admin/skill-detail",
            HttpMethod.PUT,
            createHttpEntity(skillDetailTo, createAdminHeader()),
            new ParameterizedTypeReference<Response<SkillDetailTo>>() {
            }).getBody();
  ...
  public void testUpdateWithInvalidDeliveryType() {
    Map<String, String> skillDetailTo = new HashMap<>();
    skillDetailTo.put("delivery_type", "a");
    Response<String> created = template.exchange(vaultUrl + "admin/skill-detail", HttpMethod.PUT,
            createHttpEntity(skillDetailTo, createAdminHeader()),
            new ParameterizedTypeReference<Response<String>>() {
            }).getBody();
    assertThat(created.getEntity(), nullValue());
  ...
  public void testReadEmptyId() {
    Response<List<SkillDetailTo>> read = template.exchange(vaultUrl + "admin/skill-detail/{skillDetailId}",
            HttpMethod.GET,
            createHttpEntity(createAdminHeader()),
  ...
  public void testReadEmptyWithInvalidId() {
    Response<SkillDetailTo> read = template.exchange(vaultUrl + "admin/skill-detail/{skillDetailId}",
            HttpMethod.GET,
            createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<SkillDetailTo>>() {
            }, "testing").getBody();
  ...
  public void testDelete() {
    ...
    assertThat(createdSkill.getEntity(), notNullValue());
    Response<Boolean> deleted = template.exchange(vaultUrl + "admin/skill-detail/{skillDetailId}", HttpMethod.DELETE,
            createHttpEntity(createAdminHeader()),
    ...
    Response<Boolean> read = template.exchange(vaultUrl + "admin/skill-detail/{skillDetailId}", HttpMethod.GET,
            createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<Boolean>>() {
            }, createdSkill.getEntity().getId()).getBody();
    assertThat(read.getEntity(), nullValue());
  ...
  public void testDeleteEmptyId() {
    Response<String> read = template.exchange(vaultUrl + "admin/skill-detail/{skillDetailId}", HttpMethod.DELETE,
            createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<String>>() {
            }, " ").getBody();
    assertThat(read.getEntity(), nullValue());
  ...
  public void testList() {
    Response<List<SkillDetailTo>> list = template.exchange(vaultUrl + "admin/skill-detail", HttpMethod.GET,
            createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<List<SkillDetailTo>>>() {
            }).getBody();
    ...
    assertThat(createdSkill.getEntity(), notNullValue());
    list = template.exchange(vaultUrl + "admin/skill-detail", HttpMethod.GET,
            createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<List<SkillDetailTo>>>() {
            }).getBody();
    assertThat(list.getEntity(), notNullValue());
  ...
  public void testListWithToken() {
    UnauthorizedError list = template.exchange(vaultUrl + "admin/skill-detail", HttpMethod.GET,
