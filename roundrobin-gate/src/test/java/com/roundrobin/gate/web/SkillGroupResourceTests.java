...
import static com.roundrobin.gate.common.ErrorCodes.SKILL_GROUP_ALREADY_EXISTS;
...
public class SkillGroupResourceTests extends ResourceTests {
  ...
  public void testCreate() {
    ...
    Response<SkillGroupTo> created = template.exchange(gateUrl + "admin/skill-group", HttpMethod.POST,
  ...
  public void testCreateWithDuplicateName() {
    ...
    assertThat(created.getEntity(), notNullValue());
    assertThat(created.getEntity().getGroupName().get(), is(groupName));
    Response<String> duplicate = template.exchange(gateUrl + "admin/skill-group", HttpMethod.POST,
            createHttpEntity(skillGroupTo, createAdminHeader()),
  ...
  public void testUpdate() {
    ...
    Response<SkillGroupTo> created =
            template.exchange(gateUrl + "admin/skill-group", HttpMethod.POST,
                    createHttpEntity(skillGroupTo, createAdminHeader()),
                    new ParameterizedTypeReference<Response<SkillGroupTo>>() {
                    }).getBody();
    assertThat(created.getEntity(), notNullValue());
    ...
    Response<SkillGroupTo> updated = template.exchange(gateUrl + "admin/skill-group",
            HttpMethod.PUT,
            createHttpEntity(skillGroupTo, createAdminHeader()),
            new ParameterizedTypeReference<Response<SkillGroupTo>>() {
            }).getBody();
  ...
  public void testUpdateWithNullId() {
    ...
    SkillGroupTo skillGroupTo = new SkillGroupTo();
    skillGroupTo.setGroupName(Optional.of(groupName));
    Response<SkillGroupTo> updated = template.exchange(gateUrl + "admin/skill-group", HttpMethod.PUT, createHttpEntity
  ...
  public void testUpdateWithInvalidLengthName() {
    ...
    SkillGroupTo skillGroupTo = new SkillGroupTo();
    skillGroupTo.setGroupName(Optional.of(groupName));
    Response<SkillGroupTo> updated = template.exchange(gateUrl + "admin/skill-group", HttpMethod.PUT,
            createHttpEntity(skillGroupTo, createAdminHeader()),
            new ParameterizedTypeReference<Response<SkillGroupTo>>() {
            }).getBody();
    assertThat(updated.getEntity(), nullValue());
  ...
  public void testRead() {
    ...
    assertThat(created.getEntity(), notNullValue());
    assertThat(created.getEntity().getGroupName().get(), is(groupName));
    Response<SkillGroupTo> read = template.exchange(gateUrl + "admin/skill-group/{skillGroupId}", HttpMethod.GET,
  ...
  public void testReadWithEmptyId() {
    Response<List<SkillGroupTo>> read = template.exchange(gateUrl + "admin/skill-group/{skillGroupId}", HttpMethod
  ...
  public void testReadWithInvalidId() {
    Response<String> read = template.exchange(gateUrl + "admin/skill-group/{skillGroupId}", HttpMethod.GET,
            createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<String>>() {
            }, "testing").getBody();
    assertThat(read.getEntity(), nullValue());
  ...
  public void testDelete() {
    ...
    Response<Boolean> deleted =
            template.exchange(gateUrl + "admin/skill-group/{skillGroupId}", HttpMethod.DELETE,
                    createHttpEntity(createAdminHeader()),
    ...
    Response<Boolean> read =
            template.exchange(gateUrl + "admin/skill-group/{skillGroupId}", HttpMethod.GET,
                    createHttpEntity(createAdminHeader()),
                    new ParameterizedTypeReference<Response<Boolean>>() {
                    }, created.getEntity().getId()).getBody();
    assertThat(read.getEntity(), nullValue());
  ...
  public void testDeleteWithEmptyId() {
    Response<Boolean> read = template.exchange(gateUrl + "admin/skill-group/{skillGroupId}", HttpMethod.DELETE,
            createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<Boolean>>() {
            }, " ").getBody();
    assertThat(read.getEntity(), nullValue());
  ...
  public void testList() {
    Response<List<SkillGroupTo>> list = template.exchange(gateUrl + "admin/skill-group", HttpMethod.GET,
            createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<List<SkillGroupTo>>>() {
            }).getBody();
    ...
    assertThat(created.getEntity(), notNullValue());
    list = template.exchange(gateUrl + "admin/skill-group", HttpMethod.GET, createHttpEntity(createAdminHeader()),
            new ParameterizedTypeReference<Response<List<SkillGroupTo>>>() {
            }).getBody();
    assertThat(list.getEntity(), notNullValue());
  ...
  public void testListWithToken() {
    UnauthorizedError list = template.exchange(gateUrl + "admin/skill-group", HttpMethod.GET,
