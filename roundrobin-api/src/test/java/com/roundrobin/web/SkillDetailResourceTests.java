...
public class SkillDetailResourceTests extends ResourceTests {
  ...
  public void testCreateWithNullValues() {
    SkillDetailTo skillDetailTo = new SkillDetailTo();
    Response<String> created = helper.post(url + "skill-detail", skillDetailTo, new ParameterizedTypeReference<Response<String>>() {
    }, port).getBody();
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(new Error(ErrorCode.INVALID_FIELD.getCode(), "name: may not be empty"), new Error(ErrorCode.INVALID_FIELD.getCode(), "skillGroupId: may not be empty"), new Error(ErrorCode.INVALID_FIELD.getCode(), "deliveryType: may not be null")));
  }
  ...
  public void testCreateWithInvalidDeliveryType() {
    ...
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(new Error(ErrorCode.UNPARSABLE_INPUT.getCode(), messages.getErrorMessage(ErrorCode.UNPARSABLE_INPUT))));
  }
  ...
  public void testCreateWithInvalidValues() {
    ...
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(new Error(ErrorCode.INVALID_FIELD.getCode(), "name: must match \"^[A-Za-z0-9]*$\""), new Error(ErrorCode.INVALID_FIELD.getCode(), "skillGroupId: may not be empty"), new Error(ErrorCode.INVALID_FIELD.getCode(), "deliveryType: may not be null")));
  }

  @Test
  public void testCreateWithInvalidNameLength() {
    SkillDetailTo skillDetailTo = new SkillDetailTo();
    skillDetailTo.setName(Optional.of("sadasldasldhajshdkasjhdkashdjkashdkjashkjdhasjkdhkjashdkjashdkjashkjdhaskdhakjsdhkjas"));
    Response<String> created = helper.post(url + "skill-detail", skillDetailTo, new ParameterizedTypeReference<Response<String>>() {
    }, port).getBody();
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(new Error(ErrorCode.INVALID_FIELD.getCode(), "name: length must be between 0 and 25"), new Error(ErrorCode.INVALID_FIELD.getCode(), "skillGroupId: may not be empty"), new Error(ErrorCode.INVALID_FIELD.getCode(), "deliveryType: may not be null")));
  }
  ...
  public void testCreateWithInvalidGroupId() {
    ...
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(new Error(ErrorCode.INVALID_SKILL_GROUP_ID.getCode(), messages.getErrorMessage(ErrorCode.INVALID_SKILL_GROUP_ID))));
  }
  ...
  public void testUpdate() {
    ...
    Response<SkillDetailTo> updatedSkill = helper.put(url + "skill-detail", createdSkill.getEntity(), new ParameterizedTypeReference<Response<SkillDetailTo>>() {
    }, port).getBody();
    ...
    }, port, updatedSkill.getEntity().getId()).getBody();
  ...
  public void testUpdateWithEmptySkillId() {
    SkillDetailTo skillDetailTo = new SkillDetailTo();
    Response<SkillDetailTo> updatedSkill = helper.put(url + "skill-detail", skillDetailTo, new ParameterizedTypeReference<Response<SkillDetailTo>>() {
    }, port).getBody();
    assertThat(updatedSkill.getEntity(), nullValue());
    assertThat(updatedSkill.getErrors(), notNullValue());
    assertThat(updatedSkill.getErrors(), hasItems(new Error(ErrorCode.INVALID_FIELD.getCode(), "id: may not be empty")));
  }
  ...
  public void testUpdateWithInvalidSkillId() {
    ...
    assertThat(updatedSkill.getEntity(), nullValue());
    assertThat(updatedSkill.getErrors(), notNullValue());
    assertThat(updatedSkill.getErrors(), hasItems(new Error(ErrorCode.INVALID_SKILL_DETAIL_ID.getCode(), messages.getErrorMessage(ErrorCode.INVALID_SKILL_DETAIL_ID))));
  }
  ...
  public void testUpdateWithInvalidName() {
    ...
    assertThat(updatedSkill.getEntity(), nullValue());
    assertThat(updatedSkill.getErrors(), notNullValue());
    assertThat(updatedSkill.getErrors(), hasItems(new Error(ErrorCode.INVALID_FIELD.getCode(), "name: must match \"^[A-Za-z0-9]*$\"")));
  }
  ...
  public void testUpdateWithInvalidNameLength() {
    ...
    assertThat(updatedSkill.getEntity(), nullValue());
    assertThat(updatedSkill.getErrors(), notNullValue());
    assertThat(updatedSkill.getErrors(), hasItems(new Error(ErrorCode.INVALID_FIELD.getCode(), "name: length must be between 0 and 25")));
  }
  ...
  public void testUpdateWithInvalidDeliveryType() {
    Map<String, String> skillDetailTo = new HashMap<>();
    skillDetailTo.put("deliveryType", "a");
    Response<String> created = helper.put(url + "skill-detail", skillDetailTo, new ParameterizedTypeReference<Response<String>>() {
    }, port).getBody();
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(new Error(ErrorCode.UNPARSABLE_INPUT.getCode(), messages.getErrorMessage(ErrorCode.UNPARSABLE_INPUT))));
  }
  ...
  public void testRead() {
    ...
    assertThat(createdSkill.getEntity(), notNullValue());
    Response<SkillDetailTo> read = helper.get(url + "skill-detail/{skillDetailId}", new ParameterizedTypeReference<Response<SkillDetailTo>>() {
    }, port, createdSkill.getEntity().getId()).getBody();
    assertThat(read.getEntity(), notNullValue());
  ...
  public void testDelete() {
    ...
    assertThat(createdSkill.getEntity(), notNullValue());
    Response<Boolean> deleted = helper.delete(url + "skill-detail/{skillDetailId}", new ParameterizedTypeReference<Response<Boolean>>() {
    }, port, createdSkill.getEntity().getId()).getBody();
    assertThat(deleted.getEntity(), notNullValue());
    assertThat(deleted.getEntity(), is(true));
    Response<Boolean> read = helper.get(url + "skill-detail/{skillDetailId}", new ParameterizedTypeReference<Response<Boolean>>() {
    }, port, createdSkill.getEntity().getId()).getBody();
    assertThat(read.getEntity(), nullValue());
    assertThat(read.getErrors(), hasItems(new Error(ErrorCode.INVALID_SKILL_DETAIL_ID.getCode(), messages.getErrorMessage(ErrorCode.INVALID_SKILL_DETAIL_ID))));
  }
  ...
  public void testDeleteEmptyId() {
    Response<String> read = helper.delete(url + "skill-detail/{skillDetailId}", new ParameterizedTypeReference<Response<String>>() {
    }, port, " ").getBody();
    assertThat(read.getEntity(), nullValue());
    assertThat(read.getErrors(), hasItems(new Error(ErrorCode.INVALID_URL.getCode(), messages.getErrorMessage(ErrorCode.INVALID_URL))));
  }
