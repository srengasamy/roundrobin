...
public class CreditCardResourceTests extends ResourceTests {
  ...
  public void testCreate() {
    ...
    creditCardTo.setNameOnCard(Optional.of("Suresh Rengasamy"));
    ...
    assertThat(read.getEntity().getCardNumber().get(), is(creditCardTo.getCardNumber().get()));
    assertThat(read.getEntity().getNameOnCard().get(), is(creditCardTo.getNameOnCard().get()));
    ...
    assertThat(read.getEntity().getCvv().get(), is(creditCardTo.getCvv().get()));
  ...
  public void testCreateWithEmptyValues() {
    ...
    assertThat(created.getErrors(), hasItems(
            ...
            new Error(ErrorCode.INVALID_FIELD.getCode(), "nameOnCard: may not be empty"),
  ...
  public void testCreateWithInvalidValues() {
    CreditCardTo creditCardTo = new CreditCardTo();
    creditCardTo.setNameOnCard(Optional.of("fjsdhfkdsfskdfjksdjfksdjfksdjkfkdsfksdjkfjsdhfkhdsjfhsdjhfkjsdhfjkdshfkjsdhfjshdkjfhsdkjfhksdjhfkjsdhfkjsdhfkjsdhfk"));
    ...
    assertThat(created.getErrors(), hasItems(
            ...
            new Error(ErrorCode.INVALID_FIELD.getCode(), "nameOnCard: length must be between 0 and 100")
    ));
  }
  ...
  public void testUpdate() {
    ...
    created.getEntity().setNameOnCard(Optional.of("testing"));
    created.getEntity().setCardNumber(Optional.of("4147202198882233"));
    ...
    assertThat(read.getEntity(), notNullValue());
    assertThat(read.getEntity().getCardNumber().get(), is(created.getEntity().getCardNumber().get()));
    assertThat(read.getEntity().getNameOnCard().get(), is(created.getEntity().getNameOnCard().get()));
    ...
    assertThat(read.getEntity().getCvv().get(), is(created.getEntity().getCvv().get()));
