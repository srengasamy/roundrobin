...
public class SkillResourceTests extends ResourceTests {
  ...
  public void testCreateWithInvalidProfileId() {
    ...
    skillTo.setSkillDetailId(skillDetailTo.getId());
    skillTo.setTimeToComplete(Optional.of(10));
    Response<String> created = helper.post(url + "skill", skillTo, new ParameterizedTypeReference<Response<String>>() {
    }, port).getBody();
  ...
  public void testCreateWithInvalidSkillDetailId() {
    ...
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(
            new Error(ErrorCode.INVALID_SKILL_DETAIL_ID.getCode(), messages.getErrorMessage(ErrorCode.INVALID_SKILL_DETAIL_ID))
    ));
  }
  ...
  public void testCreateWithInvalidTTC() {
    ...
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(
            new Error(ErrorCode.INVALID_FIELD.getCode(), "timeToComplete: must be between 10 and 600")
    ));
  }
  ...
  public void testCreateWithEmptyValues() {
    ...
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(
            new Error(ErrorCode.INVALID_FIELD.getCode(), "skillDetailId: may not be empty"),
            new Error(ErrorCode.INVALID_FIELD.getCode(), "timeToComplete: may not be null"),
  ...
  public void testCreateWithEmptyCost() {
    ...
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(
            new Error(ErrorCode.INVALID_FIELD.getCode(), "Invalid cost value")
    ));
  }
  ...
  public void testUpdate() {
    ...
    Response<SkillTo> updated = helper.put(url + "skill", read.getEntity(), new ParameterizedTypeReference<Response<SkillTo>>() {
    }, port).getBody();
    assertThat(updated.getEntity(), notNullValue());
    read = helper.get(url + "skill/{skillId}", new ParameterizedTypeReference<Response<SkillTo>>() {
    }, port, created.getEntity().getId()).getBody();
  ...
  public void testUpdateWithEmptyValues() {
    Response<String> updated = helper.put(url + "skill", new SkillTo(), new ParameterizedTypeReference<Response<String>>() {
    }, port).getBody();
  ...
  public void testUpdateWithInvalidSkillId() {
    ...
    skillTo.setMaxCost(Optional.of(10.0));
    skillTo.setTimeToComplete(Optional.of(10));
    Response<String> updated = helper.put(url + "skill", skillTo, new ParameterizedTypeReference<Response<String>>() {
    }, port).getBody();
    assertThat(updated.getEntity(), nullValue());
    assertThat(updated.getErrors(), notNullValue());
    assertThat(updated.getErrors(), hasItems(
  ...
  public void testUpdateWithEmptyCost() {
    ...
    skillTo.setUserProfileId("testing");
    skillTo.setSkillDetailId("testing");
    Response<SkillTo> created = helper.put(url + "skill", skillTo, new ParameterizedTypeReference<Response<SkillTo>>() {
    }, port).getBody();
    assertThat(created.getEntity(), nullValue());
    assertThat(created.getErrors(), hasItems(
            new Error(ErrorCode.INVALID_FIELD.getCode(), "Invalid cost value")
  ...
  public void testDelete() {
    ...
    assertThat(read.getEntity(), notNullValue());
    Response<Boolean> deleted = helper.delete(url + "skill/{skillId}", new ParameterizedTypeReference<Response<Boolean>>() {
    }, port, created.getEntity().getId()).getBody();
  ...
  public void testDeleteWithEmptyId() {
    Response<SkillTo> read = helper.delete(url + "skill/{skillId}", new ParameterizedTypeReference<Response<SkillTo>>() {
    }, port, " ").getBody();
    assertThat(read.getEntity(), nullValue());
    assertThat(read.getErrors(), hasItems(
            new Error(ErrorCode.INVALID_URL.getCode(), messages.getErrorMessage(ErrorCode.INVALID_URL))
